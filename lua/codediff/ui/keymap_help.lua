...
local function build_sections(keymaps, is_explorer, is_history, is_conflict)
  ...
  table.insert(view_items, { km.comment_add, "Add pending comment" })
  table.insert(view_items, { km.comment_edit, "Edit pending comment" })
  table.insert(view_items, { km.comment_remove, "Remove pending comment" })
  table.insert(view_items, { km.comment_submit, "Submit pending comments" })
  table.insert(view_items, { km.comment_list, "List pending comments" })
  table.insert(view_items, { km.comment_clear, "Clear pending comments" })
